...
export default function Dashboard(){
  ...
  const lastScore = sessions.length > 1 ? sessions[0].score : null;
  const secondToLastScore = sessions.length > 1 ? sessions[1].score : null;
  const recentChange = lastScore && secondToLastScore ? lastScore - secondToLastScore : 0;
